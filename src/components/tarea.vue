                        ...
                        <div class="card-body">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button v-on:click="agregarTarea()" class="btn btn-success btn-lg">Añadir tarea</button>
                                </div>
                            </div>
                            <br>
                            <h6 v-if="listTareas.length == 0">No hay tareas para realizar</h6>
                            <ul class="list-group">
                                ...
                                class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span class="text-danger cursor">
                                        <i class="far fa-trash-alt" v-on:click="eliminarTarea(index)"></i>
                                    </span>
                                </li>
                            </ul>
                        </div>
